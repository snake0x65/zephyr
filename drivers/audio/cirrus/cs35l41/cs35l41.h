...
#ifndef AUDIO_CODEC_CS35L41_H_
#define AUDIO_CODEC_CS35L41_H_
...
#include "../common/cirrus_bus_impl.h"
...
enum cs35l41_cspl_mbox_status {
	CSPL_MBOX_STS_ERROR = UINT32_MAX,
...
#define CS35L41_GLOBAL_BOOT_DONE_TIMEOUT_US	100000
#define CS35L41_GLOBAL_BOOT_DONE_SLEEP_US	1000

struct cs35l41_config {
	enum cirrus_bus_type bus_type;
	struct cirrus_bus_io *bus_io;
	...
	/* Optional GPIOs / clocks / reset lines could go here */
...
extern const struct audio_codec_api cs35l41_api;
int cs35l41_common_init(const struct device *dev);

#endif /* AUDIO_CODEC_cs35l41_H_ */
